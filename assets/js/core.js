            ...
            window.wacore.crm = {
                ...
                insertButtonFecharChat: function() {
                    try {
                        ...
                        e.innerHTML = ' <svg width="20" height="20" xmlns="http://www.w3.org/2000/svg" style="margin-right: 5px;" viewBox="0 0 24 24" fill-rule="evenodd" clip-rule="evenodd"><path d="M12 0c6.623 0 12 5.377 12 12s-5.377 12-12 12-12-5.377-12-12 5.377-12 12-12zm0 1c6.071 0 11 4.929 11 11s-4.929 11-11 11-11-4.929-11-11 4.929-11 11-11zm0 10.293l5.293-5.293.707.707-5.293 5.293 5.293 5.293-.707.707-5.293-5.293-5.293 5.293-.707-.707 5.293-5.293-5.293-5.293.707-.707 5.293 5.293z"/> <span data-translate-key="toClose"></svg>',
