(()=>{
    document.addEventListener('click', function(event) {
        ...
        if (event.target.tagName.toLowerCase() === 'input' || event.target.classList.contains('item-tag-cores')) {
            return; // If it's an input, do nothing
        }
                ...
                updateSelectedList: async function() {
                    try {
                        ...
                        if (n && wacore.activeChat) {
                            ...
                            e && ("Mover para uma lista" != r && (o += `<li role="button" class="dropdown-item my-dropdown-item" style="display: flex;font-weight: 800;color: rgb(207 81 61) !important;" onclick="window.wacore.crm.removerCardDOM('${s.split("@")[0]}')">${window.wacore.svgs.circle_minus(18, 18, "margin-top: 4px;margin-right: 5px;")} <span data-translate-key="close"></li>`,
                    ...
                    try {
                        ...
                        if (c) {
                            ...
                            if (c && d) {
                                ...
                                n && ("Mover para uma lista" != u && (w += `<li role="button" class="dropdown-item my-dropdown-item" style="display: flex;font-weight: 800;color: rgb(207 81 61) !important;" onclick="window.wacore.crm.removerCardDOM('${e.split("@")[0]}')">${window.wacore.svgs.circle_minus(18, 18, "margin-top: 4px;margin-right: 5px;")}<span data-translate-key="close"></li>`,
        ...
        811: ()=>{
            window.wacore.html = {
                ...
                getHtmlMenuLeft: function() {
                    return `\n    <div class="main-todo" id="canva-referencia-tela"> \n    <div class="flex-column flex-shrink-0 text-white bg-mw-sidebar sidebar-top-detail" id="menu-l01" style="display: flex">\n        <div class="d-flex align-items-center"> \n          <div class="fs-4 text-center action-expand logo-mw-recolhe" style="background-image: url('${window.infoWl.logoMenuUrl}')"></div>\n        </div>\n\n      <div style="\n        display: flex;\n        align-items: center;\n        justify-content: center;\n        padding-left: 10px;\n        padding-right: 10px;\n        padding-top: 5px;\n        padding-bottom: 5px;\n        margin-bottom: 5px;\n        margin-top: 3px;\n      ">\n        <div\n            class="bandeira"\n            style="\n              width: 30px;\n              height: 16px;\n              background-size: cover;\n              cursor: pointer;\n              border-radius: 6px;\n            "\n            onclick="window.wacore.format_translation.showFlags()"\n          ></div>\n      </div>\n        <div class="opcoes-bandeira" style="\n        display: none;\n        width: 140px;\n        margin-left: 10px;\n        background-color: #ccc;\n        z-index: 999;\n        position: absolute;\n        top: 56px;\n        left: 50px;\n        background: rgba( 12, 19, 24, 0.35 );\n        backdrop-filter: blur( 20px );\n        -webkit-backdrop-filter: blur( 20px );\n        border-radius: 2px;\n        border: 1px solid rgba( 255, 255, 255, 0.18 );">\n          <div\n            class="option-flag"\n            style="\n            margin: 5px;\n            cursor: pointer;\n            padding: 6px;\n            backdrop-filter: blur( 20px );\n            -webkit-backdrop-filter: blur( 20px );\n            border-radius: 2px;\n            background: rgba( 77, 87, 93, 0.35 );\n            transition: background 0.5s ease"\n            onclick="window.wacore.format_translation.selectFlag(window.wacore.format_translation.flags.pt, 'pt')"\n          >\n            <div\n              class="content-bandeira-nome"\n              style="display: flex; align-items: center; gap: 4px"\n            >\n              <img src="https://static.todamateria.com.br/upload/ba/nd/bandeira-do-brasil-og.jpg" class="bandeira-nome" style="width: 30px; border-radius: 4px;" />\n              <span class="name-language" >Português</span>\n            </div>\n          </div>\n          <div\n            class="opcao"\n            style="\n            margin: 5px;\n            cursor: pointer;\n            padding: 6px;\n            backdrop-filter: blur( 20px );\n            -webkit-backdrop-filter: blur( 20px );\n            border-radius: 2px;\n            background: rgba( 77, 87, 93, 0.35 );\n            transition: background 0.5s ease\n            "\n            onclick="window.wacore.format_translation.selectFlag(window.wacore.format_translation.flags.en, 'en')"\n          >\n            <div\n              class="content-bandeira-nome"\n              style="display: flex; align-items: center; gap: 4px"\n            >\n              <img src="https://static.mundoeducacao.uol.com.br/mundoeducacao/2022/05/bandeira-estados-unidos.jpg" class="bandeira-nome" style="width: 30px; border-radius: 4px;" />\n              <span class="name-language" >English</span>\n            </div>\n          </div>\n        </div>\n        \n        <div class="nav nav-pills flex-column mb-auto scrollarea" id="v-pills-tab-list" role="tablist" aria-orientation="vertical" style="">\n          \n          <div class="utrak-link menu-tooltip activeTab active" id="v-pills-whatsapp-button" data-translate-key="conversations"\n          title="" data-bs-toggle="pill" data-bs-target="#v-pills-connect" type="button" role="tab" aria-controls="v-pills-connect" aria-selected="false" onclick="window.wacore.crm.openwhatsapp(); window.wacore.crm.updateListFilter()" data-title="whatsappweb">\n            <div class="server invite invite-active" >\n              ${window.wacore.svgs.chat(30, 30, "")}\n            </div>\n            <span id="chat-unread-count" style="margin-top: 42px;" data-translate-key="unreadMessageExceptArchive" title=""></span>\n          </div>\n    \n          <div  class="utrak-link menu-tooltip btnattr" id="v-pills-crm-tab" data-translate-key="crmMode" title="" onclick="window.wacore.crm.opencrm()" data-title="crm">\n            <button class="server invite" id="btn-crm" disabled>   \n              ${window.wacore.svgs.kanban(25, 25, "margin-bottom:6px")}\n            </button>\n          </div>\n\n          <div  class="utrak-link menu-tooltip btnattr" id="v-pills-metrics-tab" title="" data-translate-key="metrics" data-bs-toggle="pill" data-bs-target="#v-pills-metrics" type="button" role="tab" aria-controls="v-pills-metrics" aria-selected="false"  onclick="wacore.html.tpl_metrics()" data-title="metricas">\n            <button class="server invite" id="btn-metricas" disabled>  \n              ${window.wacore.svgs.graphics(25, 25, "margin-bottom:6px")}\n            </button>\n          </div>\n      \n          <div  class="utrak-link menu-tooltip btnattr" id="v-pills-agendamento-tab" title="" data-translate-key="schedulingCenter" data-bs-toggle="pill" data-bs-target="#v-pills-agendamento" type="button" role="tab" aria-controls="v-pills-agendamento" aria-selected="false" onclick="window.wacore.activeChat=null" data-title="agendamento">\n            <button class="server invite" id="btn-agendamentos" disabled> \n              ${window.wacore.svgs.calendar(28, 28, "margin-bottom:6px")}\n            </button>\n          </div>\n      \n          <div  class="utrak-link menu-tooltip btnattr" id="v-pills-disparomassa-tab" title="" data-translate-key="transmissionsShots" data-bs-toggle="pill" data-bs-target="#v-pills-disparomassa" type="button" role="tab" aria-controls="v-pills-disparomassa" aria-selected="false" onclick="window.wacore.modules.msgpronta_lista('disparomassa')" data-title="disparo">\n            <button class="server invite" id="btn-disparo-massa" disabled> \n              ${window.wacore.svgs.campaign(28, 28, "margin-bottom:6px")}\n            </button>\n          </div>\n    \n          <div  class="utrak-link-solo menu-tooltip btnattr" id="v-pills-fav-messages" title="" data-translate-key="messagesAndScripts" onclick="window.wacore.modules.openMessages();" data-title="mensagens">\n            <button class="server invite" id="btn-msg-fav" disabled>   \n              ${window.wacore.svgs.fav_messages(28, 28, "margin-bottom:6px")}\n            </button>\n          </div>\n\n          <div  class="utrak-link menu-tooltip btnattr" id="v-pills-api-tab"  title="" data-translate-key="apiAndWebhooksModule" data-bs-toggle="pill" data-bs-target="#v-pills-api" type="button" role="tab" aria-controls="v-pills-api" aria-selected="false" onclick="window.wacore.api.functions.initGridLogs()" style="height: 10%;">\n            <button class="server invite" id="btn-api" disabled>   \n              ${window.wacore.svgs.api(25, 25, "margin-bottom:6px")}\n            </button>\n            <span id="unprocessed-count"></span>\n          </div>\n      \n          <div  class="utrak-link menu-tooltip btnattr" id="v-pills-modulos-tab" title="" data-translate-key="modulesExtraResources" data-bs-toggle="pill" data-bs-target="#v-pills-modulos" type="button" role="tab" aria-controls="v-pills-modulos" aria-selected="false" data-title="modulos">\n            <button class="server invite" id="btn-modulos" disabled>\n              ${window.wacore.svgs.modules(25, 25, "margin-bottom:6px")}\n            </button>\n          </div>\n        </div>\n\n        <div id="login-class">\n          <div class="d-flex justify-content-center">\n            <div class="spinner-border" role="status"></div>\n          </div>\n        </div>\n        <span class="version-app">v${window.infoWl.version}</span>\n      </div>`
                },
            ...
            window.wacore.crm = {
                ...
                insertButtonFecharChat: function() {
                    try {
                        ...
                        e.innerHTML = ' <svg width="20" height="20" xmlns="http://www.w3.org/2000/svg" style="margin-right: 5px;" viewBox="0 0 24 24" fill-rule="evenodd" clip-rule="evenodd"><path d="M12 0c6.623 0 12 5.377 12 12s-5.377 12-12 12-12-5.377-12-12 5.377-12 12-12zm0 1c6.071 0 11 4.929 11 11s-4.929 11-11 11-11-4.929-11-11 4.929-11 11-11zm0 10.293l5.293-5.293.707.707-5.293 5.293 5.293 5.293-.707.707-5.293-5.293-5.293 5.293-.707-.707 5.293-5.293-5.293-5.293.707-.707 5.293 5.293z"/></svg><span data-translate-key="toClose">',
                    ...
                    try {
                        if (document.querySelector("#fechar-chat")) {
                            ...
                            if (e && t) {
                                ...
                                e && e.setAttribute("style", "width: 100%!important"),
